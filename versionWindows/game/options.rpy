...
define gui.about = _p("""Créé par RAPHAËL GARNIER

Ce jeu a été développé dans un but purement éducatif, 
dans le cadre de cours « Développement de jeux vidéo 2D » donné à l'Université de Lausanne en 2019 par Isaac Pante.
Toutes les ressources utilisées pour ce jeu appartiennent aux propriétaires concernés,
pour un usage exclusivement non-commercial.

This game has been developped for nonprofit education purposes only, as part of the « 2D Game Development » lesson,
given in 2019 at the University of Lausanne by Isaac Pante. 
All ressources used in this game belong to the concerned owners, for an exclusively non-commercial use.

{b}Aucune intention d'enfreindre le Copyright.
No Copyright infringement is intended.{/b}

_ _ _

{b}Références des tableaux :{/b}

Caspar David Friedrich, « Abtei im Eichwald », 1809-1810, huile sur toile, 110 cm x 171 cm, Alte Nationalgalerie, Berlin.

Jean-François de Troy, « Le Déjeuner d'huîtres », 1735, huile sur toile, 180 cm x 126 cm, Musée Condé, Chantilly.

Inconnu, « Lunch atop a skyscraper », 1932, photographie, Bettmann Archive, New York.

_ _ _

{b}Références des sons et musiques :{/b}

Sons et bruitages : http://www.universal-soundbank.com/ - https://freesound.org/

Musiques d'ambiance : https://www.bensound.com/

Musique de fin : « Doopliss Battle - Paper Mario: The Thousand-Year Door », composé par Yoshito Hirano et Yuka Tsujiyoko, 2004.

_ _ _

{b}Références des musiques à l'intérieur des tableaux :{/b}

Funky Channel 2, « Crows Sound - Night forest Sounds - 8 Hours - Relaxing sounds,deep sleep », YouTube.

Viz HQ, « Marin Marais - Chaconne pour les Tritons French rococo music », YouTube.

Past Perfect Vintage Music, « Jazz Age: Hot Sounds Of The 1920s & 30s (Past Perfect) Expertly remastered », YouTube.

_ _ _

Publié pour la première fois : janvier 2020.
""")
...
define config.main_menu_music = "Stems3.mp3"
...
define config.save_directory = "MUSEE_X_JEU-1574089133"
...
define config.window_icon = "iconX.png"
